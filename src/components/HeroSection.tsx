...
export const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-[92vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white max-w-3xl px-6 mb-10">
        ...
        <div className="bg-white/10 rounded-2xl p-2 flex items-center gap-2 shadow-2xl max-w-xl mx-auto">
          <input
            type="text"
            ...
            className="flex-1 px-4 py-3 text-white-900 outline-none text-sm bg-transparent"
          />
          <button
